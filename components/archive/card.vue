...
<template>
  <article
    class="group border border-gray-800 m-2 rounded-2xl overflow-hidden shadow-sm text-zinc-300"
  >
    <NuxtLink :to="path" class="grid grid-cols-1 sm:grid-cols-10 gap-1">
      ...
      <div class="sm:col-span-7 p-5">
        ...
        <div class="text-zinc-300 text-sm mt-2 mb-1 md:flex md:space-x-6">
        ...
        <div class="flex group-hover:underline text-sky-400 items-center pt-2">
          <p>Read More</p>
        </div>
      </div>
    </NuxtLink>
